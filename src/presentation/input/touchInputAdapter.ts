...
export class TouchInputAdapter {
  public constructor(private readonly bus: PlayerCommandBus, private readonly root: ParentNode = document) {}
  public start(): void { this.root.addEventListener('pointerup', this.onPointerUp as EventListener); }
  public stop(): void { this.root.removeEventListener('pointerup', this.onPointerUp as EventListener); }
